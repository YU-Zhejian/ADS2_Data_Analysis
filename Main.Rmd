...
As can be seen from the above figure, there are some specific featrues of each region plot. Therefore, we decided to explore whether there is significat distinction between locations, and the contribution of each factor (`sex`, `age`, `cause`, `measure`, `year`, `val`) to the region, that is, how much difference each attribute contributes.
