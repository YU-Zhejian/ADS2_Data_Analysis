...
As can be seen from the above figure, some visible differences can be seen among other regions. Therefore, we decided to explore whether there is distinction between locations, and the contribution of each factor (`sex`, `age`, `cause`, `measure`, `year`, `val`) to the region, that is, how much difference each data contributes.
