...
In this part, we will build a classification tree model using C5.0 algorithm provided by R package `C50`.

## Question 4: Which factor have the greatest impact on death rate?

## Question 5: Try to predict TODO?
...
# Error plot
err <- m$boostResults
ggscatter(err, x="Trial", y="Percent", add = "reg.line", add.params = list(color = "blue", fill = "lightgray"),
          conf.int = TRUE) + geom_line()
# Overfitting
